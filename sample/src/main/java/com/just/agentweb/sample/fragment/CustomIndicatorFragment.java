...
import com.just.agentweb.sample.widget.AnimatedIndicator;
...
//        mCommonIndicator.addView(mProgressBar,lp);
		...
		AnimatedIndicator mAnimatedIndicator = new AnimatedIndicator(getActivity());

		this.mAgentWeb = AgentWeb.with(this)//
				.setAgentWebParent((ViewGroup) view, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT))
				.setCustomIndicator(mAnimatedIndicator)
